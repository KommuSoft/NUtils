//
//  INullTagDispatcherNondeterministicFiniteAutomaton.cs
//
//  Author:
...
namespace NUtils.Automata {
	...
	/// to allocate new state tags and a embedded "epsilon" edge tag.
	/// </summary>
	...
	/// allocated tag.</para>
	/// </remarks>
	public interface INullTagDispatcherNondeterministicFiniteAutomaton<TStateTag,TEdgeTag> : INullTagNondeterministicFiniteAutomaton<TStateTag,TEdgeTag>, IDispatcherNondeterministicFiniteAutomaton<TStateTag,TEdgeTag>, ICloneable<INullTagDispatcherNondeterministicFiniteAutomaton<TStateTag,TEdgeTag>> {
	}
}
