...
namespace NUtils.Visual.GraphViz {
	...
	/// <summary>
	/// A shape supported by the GraphViz DOT graph format that shapes a node as a double.
	/// </summary>
	public class CircleDotShape : NameShadow, IDotShape {

		#region Constants
		/// <summary>
		/// The GraphViz DOT graph identifier for this shape.
		/// </summary>
		public const string Identifier = "circle";
		/// <summary>
		/// The single instance created of this shape.
		/// </summary>
		public static readonly CircleDotShape Instance = new CircleDotShape ();
		#endregion
		...
		#region Constructors
		/// <summary>
		/// Initializes a new instance of the <see cref="T:CircleDotShape"/> class.
		/// </summary>
		/// <remarks>
		/// <para>Private by singleton pattern, use <see cref="Instance"/> to obtain the instance.</para>
		/// </remarks>
		private CircleDotShape () {
		}
		#endregion
	}
}
