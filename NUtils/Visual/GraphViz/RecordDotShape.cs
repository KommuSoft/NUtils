...
namespace NUtils.Visual.GraphViz {
	...
	/// </summary>
	public class RecordDotShape : NameShadow, IDotShape {

		#region Constants
		/// <summary>
		/// The GraphViz DOT graph identifier for this shape.
		/// </summary>
		public const string Identifier = "record";
		/// <summary>
		/// The single instance created of this shape.
		/// </summary>
		public static readonly RecordDotShape Instance = new RecordDotShape ();
		#endregion
		...
		#region Constructors
		/// <summary>
		/// Initializes a new instance of the <see cref="T:RecordDotShape"/> class.
		/// </summary>
		/// <remarks>
		/// <para>Private by singleton pattern, use <see cref="Instance"/> to obtain the instance.</para>
		/// </remarks>
		private RecordDotShape () {
		}
		#endregion
	}
}